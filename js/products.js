...
function allProducts() {
	return [
		...
		},
		{
			...
			images: ["images/mushrooms-1.jpg", "images/mushrooms-2.jpg", "images/mushrooms-3.jpg"]
		},
		{
			id: 7,
			name: "Avocado",
			...
			images: ["images/avocado-1.jpg", "images/avocado-2.jpg", "images/avocado-3.jpg"]
		},
		{
			id: 8,
			name: "Fresh Carrots",
			...
			images: ["images/carrots-1.jpg", "images/carrots-2.jpg", "images/carrots-3.jpg"]
		},
		{
			id: 9,
			name: "Watermelon",
...
document.addEventListener('DOMContentLoaded', () => {
                    ...
                    <div class="prod_card">
                        <div class="prod_img_box">
                            ...
                            <div class="prod_hover_box d-none d-md-flex justify-content-center align-items-center">
                                ...
                                <a href="javascript:void(0);" class="text-decoration-none d-flex justify-content-center align-items-center prod_btn" data-id="${product.id}" data-name="${product.name}" data-old-price="${product.oldPrice}" data-price="${product.price}" data-image="${product.image}" data-images="${product.images.join('|')}">
	...
	function renderPagination() {
		...
		for (let i = 1; i <= totalPages; i++) {
			...
			btn.textContent = i;
			btn.className = 'list-inline-item d-flex justify-content-center align-items-center ' + (i === currentPage ? 'active' : '');
